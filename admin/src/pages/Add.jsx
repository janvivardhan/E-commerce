...
const Add = ({token}) => {
  ...
  return (
    ...
    <div className='w-full'>
      ...
      <textarea onChange={(e) =>setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='write some description here...' required />
    </div>
