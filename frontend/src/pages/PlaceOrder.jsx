...
const PlaceOrder = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
       ...
       <input required onChange={onChangeHandler} name='email' value={fromData.email} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="email" placeholder='Email Adress'/>
       ...
       <div className='flex gap-3'>
        <input required onChange={onChangeHandler} name='zipcode' value={fromData.zipcode} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="number" placeholder='Zipcpde'/>
